...
public class RoomParserTest {
    ...
    public void testParseRoomNoRoom() throws IOException {
        ...
        try {
            ...
            Assert.assertEquals(RoomParser.errRoomNotFound, e.getBaseMessage());
        }
    }
    ...
    public void testParseRoomAndHouseId() throws IOException {
        ...
        try {
            ...
            Assert.assertEquals(RoomParser.errRoomOrHouseId, e.getBaseMessage());
        }
    }
    ...
    public void testParseRoomStateException() throws IOException {
        ...
        try {
            ...
            Assert.assertEquals(RoomParser.errRoomStateRoomBtnsNotUnique, e.getBaseMessage());
        }
        ...
        try {
            ...
            Assert.assertEquals(RoomParser.errRoomStateASize0, e.getBaseMessage());
        }
        ...
        try {
            ...
            Assert.assertEquals(RoomParser.errRoomStateFormat, e.getBaseMessage());
        }
    }
    ...
    public void testParseRoomTagsException() throws IOException {
        ...
        try {
            ...
            Assert.assertEquals(RoomParser.errRoomTagsNotUqniue, e.getBaseMessage());
        }
        ...
        try {
            ...
            Assert.assertEquals(RoomParser.errRoomTagsUnknownClass, e.getBaseMessage());
        }
        ...
        try {
            ...
            Assert.assertEquals(RoomParser.errRoomTagsStyleFormat, e.getBaseMessage());
        }
    }
    ...
    public void testParseRoomPricesException() throws IOException {
        ...
        try {
            ...
            Assert.assertEquals(RoomParser.errRoomPricesPayConNotUnique, e.getBaseMessage());
        }
        ...
        try {
            ...
            Assert.assertEquals(RoomParser.errRoomPricesTrSizeNot5, e.getBaseMessage());
        }
        ...
        try {
            ...
            Assert.assertEquals(RoomParser.errRoomPriceHeader, e.getBaseMessage());
        }
        ...
        try {
            ...
            Assert.assertEquals(RoomParser.errRoomPrice, e.getBaseMessage());
        }
        ...
        try {
            ...
            Assert.assertEquals(RoomParser.errRoomPriceDesc, e.getBaseMessage());
        }
        ...
        try {
            ...
            Assert.assertEquals(RoomParser.errRoomPriceRent, e.getBaseMessage());
        }
        ...
        try {
            ...
            Assert.assertEquals(RoomParser.errRoomPriceDeposit, e.getBaseMessage());
        }
        ...
        try {
            ...
            Assert.assertEquals(RoomParser.errRoomPriceService, e.getBaseMessage());
        }
    }
    ...
    public void testParseRoomDetailException() throws IOException {
        ...
        try {
            ...
            Assert.assertEquals(RoomParser.errRoomDetailNotUnique, e.getBaseMessage());
        }
        ...
        try {
            ...
            Assert.assertEquals(RoomParser.errRoomDetailLiSizeNot5, e.getBaseMessage());
        }
        ...
        try {
            ...
            Assert.assertEquals(RoomParser.errRoomDetailArea, e.getBaseMessage());
        }
        ...
        try {
            ...
            Assert.assertEquals(RoomParser.errRoomDetailOrientation, e.getBaseMessage());
        }
        ...
        try {
            ...
            Assert.assertEquals(RoomParser.errRoomDetailLayout, e.getBaseMessage());
        }
        ...
        try {
            ...
            Assert.assertEquals(RoomParser.errRoomDetailFloor, e.getBaseMessage());
        }
        ...
        try {
            ...
            Assert.assertEquals(RoomParser.errRoomDetailLocation, e.getBaseMessage());
        }
        ...
        try {
            ...
            Assert.assertEquals(RoomParser.errRoomDetailLocationDetail, e.getBaseMessage());
        }
    ...
    public void testParseRoomNameException() throws IOException {
        ...
        try {
            ...
            Assert.assertEquals(RoomParser.errRoomNameDetailOrNumberEmpty, e.getBaseMessage());
        }
        ...
        try {
            ...
            Assert.assertEquals(RoomParser.errRoomNameNotDetailEmpty, e.getBaseMessage());
        }
        ...
        try {
            ...
            Assert.assertEquals(RoomParser.errRoomNameBlank, e.getBaseMessage());
        }
        ...
        try {
            ...
            Assert.assertEquals(RoomParser.errRoomNameEllipsisEmpty, e.getBaseMessage());
        }
        ...
        try {
            ...
            Assert.assertEquals(RoomParser.errRoomNameNotUnique, e.getBaseMessage());
        }
        ...
        try {
            ...
            Assert.assertEquals(RoomParser.errH2NotUniqueOfRoomName, e.getBaseMessage());
        }
        ...
        try {
            ...
            Assert.assertEquals(RoomParser.errRoomNameFormat, e.getBaseMessage());
        }
